...
export function Footer() {
    return (
        <footer className="bg-[#2D231E] text-primary pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-primary text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
                    ...
                    {/* Column 2: Links */}
                    <div className="space-y-4">
                        <h4 className="text-sm font-bold uppercase tracking-widest text-primary">Navigate</h4>
                    ...
                    {/* Column 3: Contact */}
                    <div className="space-y-4">
                        <h4 className="text-sm font-bold uppercase tracking-widest text-primary">Connect</h4>
                        <p className="text-sm text-primary">Coppell, Texas</p>
                        <a
